...
| 063 | Captured | bitty-network optional Core extension: shared runtime, api/impl split, L0/L1/L2 model   |
| 064 | Captured | capability plugin architecture: share infra / request capabilities, quotas, lifecycle    |
...
| [2026-09-20](review/2026-09-20/README.md) | First-release review of Phodopus as Piccolo's proposed Bitty successor: lineage, Phase 1/1.5 implementation, sandbox and Fuel gaps, release/package integrity, documentation drift, and the remaining Phase 2-5 adoption gates. No independent reviewer sign-off is claimed.                                                  |
